...
<!-- updated at: 2026-07-10 12:00 Z   (2026-07-10 08:00 EDT) -->

> **This is XwkOnt's public contribution backlog.** It enumerates every class in all 8 source ontologies, each tagged with its nearest existing XwkOnt bucket — a **candidate** for a future crosswalk concept. If you want to contribute a crosswalk, this is where to find one: pick a bucket below that isn't yet one of the 26 `reviewed` concepts in [`docs/crosswalks/concepts/`](concepts/), and follow the selection/sourcing/scoping/review process in [`docs/governance/contributing.md`](../governance/contributing.md). "Ungrouped" rows are not yet triaged into any bucket at all — flagging one you think deserves its own concept, with source-count evidence per `ADR-0018`, is itself a useful contribution. The next admitted batch (`0.4.0`, selection only) is recorded in [`batch-0.4.0-selection.md`](batch-0.4.0-selection.md).
>
> "Core" was dropped from this file's original name (`core-concepts.md`, 2026-07-04) pending a future pass that actually defines what would qualify a candidate as "core." **That pass is now done, in two ADRs: `docs/adr/ADR-0020-define-core-as-base-module-not-domain-tier.md` (2026-07-05) defines "core" as XwkOnt's base module (distinct from optional extension modules), not a domain-tier "core ontology" in the Scherp-et-al. sense; `docs/adr/ADR-0021-source-classified-core-placement-criterion.md` (2026-07-05) then sets the actual placement rule — a concept qualifies as XwkOnt-core if *any one* contributing source ontology classifies it as part of that source's own core/base module, no cross-source majority or popularity filter on top.** Applying `ADR-0021` to all 26 reviewed concepts is complete as of `ontology-core-v0.3.0`: every reviewed concept now has a `data/ontology/core.ttl` placement. This file remains the **public contribution backlog** for classes not yet selected as their own crosswalk concept. A row is either a source's own **Concept Term** (`ADR-0011`/`ADR-0019`, e.g. BFO's `role`), a **candidate** if `ADR-0018`'s source-count threshold is met but no dedicated crosswalk exists yet, a **reviewed Concept** bucket (one of the 26 in `docs/crosswalks/concepts/`), or **Ungrouped** if not yet triaged. The 26 reviewed concepts today are the original 8, all 9 of the `0.2.0` batch, and 9 of the `0.3.0` batch (Disposition/Capacity, Symbol/Sign/Representation, Mind/Conscious Being/Agent, Ontological Level/Stratum, Change, List/Sequence, Continuous vs. Discrete, Modality, and Non-physical/Social Object), with Quality Space/Quale off-ramped as not-distinct.
>
> Enumerates every class exactly once verified against each of the 8 source ontologies' own primary artifact (re-fetched and parsed directly for this pass — the earlier draft relied on `docs/evaluations/foundational-ontology-concept-terms-matrix.md`'s simplified ASCII trees, which undercounted several sources badly). Every row is numbered `<ONTOLOGY>.<n>` and tagged with its nearest existing XwkOnt bucket (one of the 26 `reviewed` crosswalks, a still-open candidate cluster, or **Ungrouped** if no existing bucket fits). **Ungrouped does not mean "will become its own concept"** — it means "not yet triaged," per `ADR-0018`'s process: every future concept still needs its own selection/sourcing/scoping/review pass, no matter how it's listed here. Historical notes that mention `TODO.md` refer to an unpublished internal working record; this file is the public backlog going forward.
>
...
- **GUM (35→193):** by far the largest correction — the original matrix only sketched GUM's top 3 branches (`Configuration`/`Element`/`MultiConfiguration`) near the root; the full model has 193 classes. GUM is the single biggest contributor to the total, and the large majority of its classes are fine-grained linguistic clause-type/quality distinctions, most already flagged "likely NOT core" in the unpublished internal working record (and retained as Ungrouped linguistic/domain leaves here).
...
| BFO.5 | spatial region | Space |
| BFO.6 | temporal region | Time |
| BFO.7 | two-dimensional spatial region | Space |
| BFO.8 | spatiotemporal region | Time / Space |
| BFO.9 | process | Process |
| BFO.10 | disposition | Disposition / Capacity |
| BFO.11 | realizable entity | Role / Disposition |
| BFO.12 | zero-dimensional spatial region | Space |
| BFO.13 | quality | Quality |
| BFO.14 | specifically dependent continuant | Quality |
| BFO.15 | role | Role |
| BFO.16 | fiat object part | Mereology/Parthood/Aggregate |
| BFO.17 | one-dimensional spatial region | Space |
| BFO.18 | object aggregate | Mereology/Parthood/Aggregate |
| BFO.19 | three-dimensional spatial region | Space |
| BFO.20 | site | Boundary/Site |
| BFO.21 | object | Object |
| BFO.22 | generically dependent continuant | Information Artifact / Abstract/Concrete |
| BFO.23 | function | Disposition / Capacity |
| BFO.24 | process boundary | Boundary/Site |
| BFO.25 | one-dimensional temporal region | Time |
| BFO.26 | material entity | Object |
| BFO.27 | continuant fiat boundary | Boundary/Site |
| BFO.28 | immaterial entity | Continuant-Occurrent |
| BFO.29 | fiat line | Boundary/Site |
| BFO.30 | relational quality | Quality |
| BFO.31 | fiat surface | Boundary/Site |
| BFO.32 | fiat point | Boundary/Site |
| BFO.33 | zero-dimensional temporal region | Time |
| BFO.34 | history | Process |
| BFO.35 | temporal interval | Time |
| BFO.36 | temporal instant | Time |
...
| # | Class | Nearest XwkOnt bucket |
|---|---|---|
| DOLCE.1 | abstract | Abstract/Concrete |
| DOLCE.2 | abstract-quality | Quality |
| DOLCE.3 | abstract-region | Space |
| DOLCE.4 | accomplishment | Event |
| DOLCE.5 | achievement | Event |
| DOLCE.6 | amount-of-matter | Quantity/Amount of Matter |
| DOLCE.7 | arbitrary-sum | Mereology/Parthood/Aggregate |
| DOLCE.8 | dependent-place | Boundary/Site |
| DOLCE.9 | endurant | Continuant-Occurrent |
| DOLCE.10 | event | Event |
| DOLCE.11 | feature | Boundary/Site |
| DOLCE.12 | non-physical-endurant | Non-physical/Social Object |
| DOLCE.13 | non-physical-object | Non-physical/Social Object |
...
| DOLCE.19 | physical-region | Space |
| DOLCE.20 | process | Process |
| DOLCE.21 | proposition | Proposition/Content |
...
| DOLCE.25 | region | Space |
| DOLCE.26 | relevant-part | Mereology/Parthood/Aggregate |
| DOLCE.27 | set | Universal/Type |
| DOLCE.28 | space-region | Space |
| DOLCE.29 | spatio-temporal-particular | Continuant-Occurrent (root-adjacent — `equivalentClass` union, not `subClassOf`) |
| DOLCE.30 | spatio-temporal-region | Time / Space |
| DOLCE.31 | state | Situation/State of Affairs |
...
| DOLCE.35 | temporal-region | Time |
| DOLCE.36 | time-interval | Time |
...
| SUMO.2 | Abstract | Abstract/Concrete |
| SUMO.3 | Object | Object |
| SUMO.4 | Collection | Mereology/Parthood/Aggregate |
| SUMO.5 | ContentBearingPhysical | Information Artifact |
| SUMO.6 | Process | Process |
| SUMO.7 | PhysicalSystem | Object |
| SUMO.8 | Quantity | Quantity/Amount of Matter |
| SUMO.9 | Attribute | Quality |
| SUMO.10 | SetOrClass | Universal/Type |
| SUMO.11 | Relation | Relation |
| SUMO.12 | List | List / Sequence |
| SUMO.13 | Proposition | Proposition/Content |
| SUMO.14 | SelfConnectedObject | Object |
| SUMO.15 | Region | Space |
| SUMO.16 | AutonomousAgent | Mind / Conscious Being / Agent |
| SUMO.17 | AstronomicalBody | Object |
| SUMO.18 | Artifact | Information Artifact |
| SUMO.19 | ContactSite | Boundary/Site |
| SUMO.20 | CollectionOfObjects | Mereology/Parthood/Aggregate |
| SUMO.21 | CollectionOfProcesses | Mereology/Parthood/Aggregate |
...
| SUMO.34 | Number | Quantity/Amount of Matter |
| SUMO.35 | PhysicalQuantity | Quantity/Amount of Matter |
| SUMO.36 | InternalAttribute | Quality |
| SUMO.37 | RelationalAttribute | Quality / Relation |
| SUMO.38 | Class | Universal/Type |
| SUMO.39 | Set | Universal/Type |
...
| SUMO.60 | Argument | Proposition/Content |
...
| # | Class | Nearest XwkOnt bucket |
|---|---|---|
| UFO.1 | abstract | Abstract/Concrete |
| UFO.2 | category | Universal/Type |
| UFO.3 | collective | Mereology/Parthood/Aggregate |
| UFO.4 | datatype | Ungrouped |
| UFO.5 | enumeration | Ungrouped |
| UFO.6 | event | Event |
| UFO.7 | historicalRole | Universal/Type — rigidity-taxonomy detail |
| UFO.8 | historicalRoleMixin | Universal/Type — rigidity-taxonomy detail |
| UFO.9 | kind | Universal/Type — rigidity-taxonomy detail |
| UFO.10 | mixin | Universal/Type — rigidity-taxonomy detail |
| UFO.11 | mode | Disposition / Capacity |
| UFO.12 | phase | Universal/Type — rigidity-taxonomy detail |
| UFO.13 | phaseMixin | Universal/Type — rigidity-taxonomy detail |
| UFO.14 | quality | Quality |
| UFO.15 | quantity | Quantity/Amount of Matter |
| UFO.16 | relator | Relation |
| UFO.17 | role | Role |
| UFO.18 | roleMixin | Universal/Type — rigidity-taxonomy detail |
| UFO.19 | situation | Situation/State of Affairs |
| UFO.20 | subkind | Universal/Type — rigidity-taxonomy detail |
| UFO.21 | type | Universal/Type |
...
| # | Class | Nearest XwkOnt bucket |
|---|---|---|
| UFO.43 | abstractNature | Abstract/Concrete |
| UFO.44 | collectiveNature | Mereology/Parthood/Aggregate |
...
| UFO.50 | quantityNature | Quantity/Amount of Matter |
| UFO.51 | relatorNature | Relation |
| UFO.52 | situationNature | Situation/State of Affairs |
| UFO.53 | typeNature | Universal/Type |

### AggregationKind (`UFO.54`–`UFO.56`) — not in the original matrix's scope, included here for completeness

| # | Class | Nearest XwkOnt bucket |
|---|---|---|
| UFO.54 | composite | Mereology/Parthood/Aggregate |
| UFO.55 | none | Ungrouped |
| UFO.56 | shared | Mereology/Parthood/Aggregate |
...
| # | Class | Nearest XwkOnt bucket |
|---|---|---|
| GFO.1 | Abstract | Abstract/Concrete |
| GFO.2 | Action | Event / Process |
| GFO.3 | Amount_of_substrate | Quantity/Amount of Matter |
| GFO.4 | Awareness_level | Ontological Level / Stratum |
| GFO.5 | Biological_level | Ontological Level / Stratum |
| GFO.6 | Category | Universal/Type |
| GFO.7 | Change | Change |
| GFO.8 | Chemical_level | Ontological Level / Stratum |
| GFO.9 | Chronoid | Time |
| GFO.10 | Concept | Universal/Type |
| GFO.11 | Concrete | Abstract/Concrete |
| GFO.12 | Configuration | Situation/State of Affairs |
...
| GFO.29 | Item | Universal/Type |
| GFO.30 | Level | Ontological Level / Stratum |
| GFO.31 | Line | Boundary/Site |
| GFO.32 | Mass_entity | Quantity/Amount of Matter |
| GFO.33 | Material_boundary | Boundary/Site |
| GFO.34 | Material_line | Boundary/Site |
| GFO.35 | Material_object | Object |
| GFO.36 | Material_persistant | Object |
| GFO.37 | Material_point | Boundary/Site |
| GFO.38 | Material_stratum | Ontological Level / Stratum |
| GFO.39 | Material_structure | Object |
| GFO.40 | Material_surface | Boundary/Site |
...
| GFO.55 | Role | Role |
| GFO.56 | Set | Universal/Type |
| GFO.57 | Situation | Situation/State of Affairs |
| GFO.58 | Situoid | Situation/State of Affairs |
| GFO.59 | Social_role | Role |
| GFO.60 | Social_stratum | Ontological Level / Stratum |
| GFO.61 | Space | Space |
| GFO.62 | Space_time | Time / Space |
| GFO.63 | Spatial_boundary | Boundary/Site |
| GFO.64 | Spatial_region | Space |
| GFO.65 | State | Situation/State of Affairs |
| GFO.66 | Stratum | Ontological Level / Stratum |
| GFO.67 | Surface | Boundary/Site |
| GFO.68 | Symbol | Symbol/Sign/Representation |
| GFO.69 | Symbol_sequence | Symbol/Sign/Representation |
| GFO.70 | Symbol_structure | Symbol/Sign/Representation |
| GFO.71 | Temporal_region | Time |
| GFO.72 | Time | Time |
| GFO.73 | Time_boundary | Boundary/Site |
| GFO.74 | Token | Object |
| GFO.75 | Topoid | Space |
| GFO.76 | Universal | Universal/Type |
...
| YAMATO.15 | living organism | Ungrouped — domain-specific leaf, flagged "likely NOT core" |
...
| YAMATO.19 | Chemical compound | Ungrouped — domain-specific leaf, flagged "likely NOT core" |
| YAMATO.20 | morphological whole | Ungrouped — domain-specific leaf, flagged "likely NOT core" |
| YAMATO.21 | weak agent | Mind / Conscious Being / Agent |
| YAMATO.22 | non-unitary | Mereology/Parthood/Aggregate |
| YAMATO.23 | abstract | Abstract/Concrete |
| YAMATO.24 | semi-abstract | Abstract/Concrete |
| YAMATO.25 | mind | Mind / Conscious Being / Agent |
| YAMATO.26 | content | Proposition/Content |
| YAMATO.27 | proposition | Proposition/Content |
| YAMATO.28 | content_2 | Proposition/Content |
...
| YAMATO.32 | generically dependent | Information Artifact / Abstract/Concrete |
...
| YAMATO.35 | quantity | Quantity/Amount of Matter |
...
| TUPPER.11 | state | Situation/State of Affairs |
| TUPPER.12 | VoluminalRegion | Space |
| TUPPER.13 | ArealRegion | Space |
| TUPPER.14 | Curve | Boundary/Site |
| TUPPER.15 | MaterialObject | Space |
| TUPPER.16 | ShapedObject | Space |
| TUPPER.17 | ShapeFeature | Boundary/Site |
| TUPPER.18 | Max | Ungrouped |
| TUPPER.19 | MaxDim | Ungrouped |
| TUPPER.20 | Min | Ungrouped |
| TUPPER.21 | MinDim | Ungrouped |
| TUPPER.22 | PointRegion | Boundary/Site |
| TUPPER.23 | ZEX | Ungrouped |
| TUPPER.24 | box | Space |
| TUPPER.25 | point | Boundary/Site |
| TUPPER.26 | poly | Space |
| TUPPER.27 | surface | Boundary/Site |
| TUPPER.28 | edge | Boundary/Site |
| TUPPER.29 | ridge | Boundary/Site |
| TUPPER.30 | border | Boundary/Site |
| TUPPER.31 | outer | Boundary/Site |
| TUPPER.32 | vertex | Boundary/Site |
| TUPPER.33 | mat | Quantity/Amount of Matter |
| TUPPER.34 | amount | Quantity/Amount of Matter |
| TUPPER.35 | spatial_area | Space |
| TUPPER.36 | spatial_length | Space |
| TUPPER.37 | spatial_volume | Space |
...
| GUM.2 | Abstraction | Abstract/Concrete |
| GUM.3 | AddresseeOriented | Ungrouped — linguistic clause type, flagged "likely NOT core" |
...
| GUM.16 | BeingAndHaving | Situation/State of Affairs |
...
| GUM.22 | ClassAscription | Universal/Type |
...
| GUM.29 | Configuration | Situation/State of Affairs |
| GUM.30 | ConfigurationBeginning | Situation/State of Affairs |
| GUM.31 | ConfigurationBoundary | Boundary/Site |
| GUM.32 | ConfigurationContinuity | Situation/State of Affairs |
| GUM.33 | ConfigurationEnding | Situation/State of Affairs |
| GUM.34 | ConfigurationInitializing | Situation/State of Affairs |
| GUM.35 | ConfigurationResuming | Situation/State of Affairs |
| GUM.36 | ConfigurationStaging | Situation/State of Affairs |
...
| GUM.40 | DecomposableObject | Mereology/Parthood/Aggregate |
| GUM.41 | DiffuseMatter | Quantity/Amount of Matter |
| GUM.42 | Disjunction | Ungrouped — linguistic |
| GUM.43 | DisjunctiveSet | Universal/Type |
| GUM.44 | Disliking | Mind / Conscious Being / Agent |
| GUM.45 | DispositiveMaterialAction | Ungrouped — linguistic |
| GUM.46 | DoingAndHappening | Situation/State of Affairs |
| GUM.47 | DurationInTime | Time |
| GUM.48 | DynamicQuality | Quality |
| GUM.49 | Elaboration | Ungrouped — linguistic |
| GUM.50 | Element | Continuant-Occurrent |
| GUM.51 | ElementList | Mereology/Parthood/Aggregate |
| GUM.52 | ElementOf | Mereology/Parthood/Aggregate |
| GUM.53 | Enhancement | Ungrouped — linguistic |
| GUM.54 | EvaluativeQuality | Quality |
| GUM.55 | Exactly | Ungrouped — linguistic |
| GUM.56 | Existence | Situation/State of Affairs |
...
| GUM.65 | GeneralizedLocating | Space |
| GUM.66 | GeneralizedPossession | Relation |
| GUM.67 | GeneralizedPossessionInverse | Relation |
| GUM.68 | GeneralizedRoleRelation | Role |
| GUM.69 | GreaterThan | Quantity/Amount of Matter |
| GUM.70 | GreaterThanComparison | Quantity/Amount of Matter |
...
| GUM.76 | InstantaneousInTime | Time |
...
| GUM.81 | LessThan | Quantity/Amount of Matter |
| GUM.82 | LessThanComparison | Quantity/Amount of Matter |
...
| GUM.100 | MultiConfiguration | Situation/State of Affairs |
...
| GUM.103 | NameOf | Symbol/Sign/Representation |
| GUM.104 | NameRelation | Symbol/Sign/Representation |
| GUM.105 | NamedObject | Object |
| GUM.106 | NaturalNumber | Quantity/Amount of Matter |
| GUM.107 | Necessity | Modality |
| GUM.108 | NonAddresseeOriented | Ungrouped — linguistic |
| GUM.109 | NonAddressing | Ungrouped — linguistic |
| GUM.110 | NonAffectingAction | Situation/State of Affairs |
...
| GUM.119 | NumberFocusing | Quantity/Amount of Matter |
| GUM.120 | OneOrTwoDLocation | Space |
| GUM.121 | OneOrTwoDTime | Time |
| GUM.122 | OrderedObject | List / Sequence (was tagged "Mereology/Parthood/Aggregate"; retagged 2026-07-07, session verification: reifies the same ordered-collection apparatus as SUMO's `List`, not a part-whole aggregate) |
| GUM.123 | OrderedSet | List / Sequence (was tagged "Universal/Type"; retagged 2026-07-07, session verification: subclass of `OrderedObject`, the ordered-collection apparatus, not a type/universal-side class) |
| GUM.124 | OwnedBy | Relation |
| GUM.125 | Ownership | Relation |
| GUM.126 | Part | Mereology/Parthood/Aggregate |
| GUM.127 | PartOf | Mereology/Parthood/Aggregate |
| GUM.128 | PartWhole | Mereology/Parthood/Aggregate |
| GUM.129 | Past | Time |
...
| GUM.134 | Present | Time |
| GUM.135 | Process | Process |
| GUM.136 | ProfilesAndStages | Time |
...
| GUM.143 | Quantity | Quantity/Amount of Matter |
| GUM.144 | QuantityAscription | Quantity/Amount of Matter |
...
| GUM.154 | ScaledComparison | Quantity/Amount of Matter |
| GUM.155 | SenseANDMeasureQuality | Quality |
| GUM.156 | Signification | Symbol/Sign/Representation |
...
| GUM.162 | Space | Space |
| GUM.163 | SpaceInterval | Space |
| GUM.164 | SpacePoint | Space |
| GUM.165 | SpatialObject | Space |
| GUM.166 | SpatialTemporal | Space |
| GUM.167 | SpecificMatter | Quantity/Amount of Matter |
...
| GUM.172 | Substance | Quantity/Amount of Matter |
| GUM.173 | Sunning | Ungrouped — linguistic |
| GUM.174 | Symbolization | Symbol/Sign/Representation |
| GUM.175 | TaxonomicQuality | Quality |
| GUM.176 | TemporalObject | Time |
| GUM.177 | TemporalProfile | Time |
| GUM.178 | TemporallyBounded | Time |
| GUM.179 | TemporallyUnbounded | Time |
| GUM.180 | Think | Mind / Conscious Being / Agent |
| GUM.181 | ThreeDLocation | Space |
| GUM.182 | ThreeDTime | Time |
| GUM.183 | Time | Time |
| GUM.184 | TimeInterval | Time |
| GUM.185 | TimePoint | Time |
| GUM.186 | UMSet | Universal/Type |
...
| GUM.191 | Word | Symbol/Sign/Representation |
| GUM.192 | ZeroDLocation | Space |
| GUM.193 | ZeroDTime | Time |
...
- Unpublished internal working record historically referenced as `TODO.md` (not published; this file is the public backlog)
