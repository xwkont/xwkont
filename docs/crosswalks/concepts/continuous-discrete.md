...
| `xwkont:mapping:continuous-discrete:005` | xwkont-core:ContinuousDiscrete (candidate) | `unknown` | UFO | none | `semapv:ManualMappingCuration` | candidate | low | Confirmed absence (resolved 2026-07-07, session-051): full-text search of a complete paper extraction found only one informal "continuous" occurrence and zero "discrete"/"atomic"/"granular" hits; see `uncertainty-003`. | `xwkont:ref:ufo-2021` |
