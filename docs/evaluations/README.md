...
- [prior-art-survey.md](prior-art-survey.md) — Prior Art Survey: Foundational Ontology Comparison and Mapping
- [comparable-projects-survey.md](comparable-projects-survey.md) — Comparable Public Projects Survey (externally sourced via ChatGPT, not independently verified — see file for caveat)
- [standards-survey-report.md](standards-survey-report.md) — Standards Survey Report
- [standards-adoption-matrix.md](standards-adoption-matrix.md) — Standards Adoption Matrix
