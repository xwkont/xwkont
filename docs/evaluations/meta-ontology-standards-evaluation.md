...
2. Should OMV be revisited once the first concept crosswalks reveal whether DCMI-based reference records adequately describe BFO/DOLCE/SUMO/UFO as source ontologies?
