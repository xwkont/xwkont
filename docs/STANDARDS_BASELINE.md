...
| OMV | Defer | Revisit once the first concept crosswalks show whether DCMI-based reference records are sufficient for describing source ontologies (BFO/DOLCE/SUMO/UFO) as artifacts. | `docs/evaluations/meta-ontology-standards-evaluation.md` |
